...
\033[35m                                  ║ ║╣ ╠═╣║║║  ╔╩╦╝
\033[35m                                  ╩ ╚═╝╩ ╩╩ ╩  ╩ ╚═                
\033[35m                             X We are al\033[32ml clowns X
...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - DDOS v4 By \033[36m@BAL7A X \033[35m- - - - - - -║
\033[35m                ║\033[32m  - - - Type \033[36mhelp\033[35m to see the methods Menu - - - - ║
\033[35m                ╚═══════════════════════════════════════════════╝
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;bal7a. | Devices: [{}] | Spoofed Servers [19] | Server Units [8] | Clients: [18]\x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@bal7a]\033[36m$ \033[96m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
